...
import { getItems, addItem, deleteItem } from "../_services/shopping_list_service";
...
export default function ShoppingListPage() {
  ...
  // Week‑10: items now come from Firestore
        ...
        <div className="w-1/2">
          ...
          <div className="bg-slate-800 p-6 rounded-lg shadow-lg border border-slate-700 w-full">
            <ItemList 
              ...
              onDeleteItem={handleDeleteItem}   // ⭐ DELETE SUPPORT
            />
          </div>
        </div>
